...
import { Search, Edit3, Bell, User, Edit } from "lucide-react";

const Header = () => {
  return (
    <header className="flex items-center justify-between w-full h-16 py-3 px-5 bg-white border-b-[0.5px] border-gray-100">
        ...
        <div className="w-56 mx-4">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search"
              className="w-full text-sm h-10 pl-10 pr-4 rounded-full bg-gray-50 text-black focus:outline-none"
            />
          </div>
        </div>
      </div>
